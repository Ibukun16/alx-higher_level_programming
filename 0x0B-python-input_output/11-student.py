...
class Student:
    ...
    def __init__(self, first_name, last_name, age):
        """Initializing the student class definition"""
    ...
    def to_json(self, attrs=None):
        ...
        If attrs is a list strings, only attributes name contain
        in the list must be retrieved, else retrieve all attributes
