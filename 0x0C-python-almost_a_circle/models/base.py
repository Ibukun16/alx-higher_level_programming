#!/usr/bin/python3
""" Task 1 of ALX unit test project

A module that defines a base model class which will serve
as base for other classes to build on.
"""
import json
import csv
import turtle
...
class Base:
    ...
    def save_to_file(cls, list_objs):
        """Write the JSON string representation of a
